                ...
                <div class="max-w-sm p-6 bg-[#FFE4B6] border-8 border-borderColor rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-8">
                        ...
                        <div class="text-center mt-4">
                            <div><a class="text-blue-500 hover:underline" href="/register">Don't have an Account?</a></div>
                            <div><a class="text-blue-500 hover:underline" href="#">Forgot Password?</a></div>
                        </div>
                    </div>
                </div>
            </div>
